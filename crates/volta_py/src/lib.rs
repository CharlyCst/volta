//! Python bindings for the Volta PTX analysis engine (v0: `parse` and
//! `analyze` only - see `crates/volta_cli` for the full command set this
//! will grow towards, notably `compare`).
